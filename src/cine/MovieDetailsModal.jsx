...
const MovieDetailsModal = ({ movie, onClose, onCartAdd }) => {
  return (
    <div className="fixed top-0 left-0 w-screen h-screen z-50 bg-white dark:bg-black/60 backdrop-blur-sm">
        ...
        <div class="bg-white shadow-md dark:bg-[#12141D] rounded-2xl sm:grid sm:grid-cols-[2fr_1fr] overflow-hidden">
          ...
          <div className="p-5 lg:p-11">
            ...
            <div className="grid lg:grid-cols-2 gap-2">
              ...
              <a
                className="border border-[#74766F] rounded-lg py-2 px-5 flex items-center justify-center gap-2 text-[#6F6F6F] font-semibold text-sm" // dark:text-gray-200
                href="#"
                onClick={onClose}
              >
                Cancel
